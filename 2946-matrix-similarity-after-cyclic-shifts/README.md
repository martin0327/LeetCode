...
<pre><strong>Input:</strong> mat = [[1,2,1,2],[5,5,5,5],[6,3,6,3]], k = 2
...
<pre><strong>Input:</strong> mat = [[2,2],[2,2]], k = 3
<strong>Output:</strong> true
...
<pre><strong>Input:</strong> mat = [[1,2]], k = 1
